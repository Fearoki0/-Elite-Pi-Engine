...
def generate_pi_extreme(digits: int) -> str:
    ...
    # FAST PATH: For < 5000 digits, skip ALL memory management and parallel overhead.
    # We do the math inline to strip away nanoseconds of Python interpreter time.
    if digits < 5000:
        n_terms = int(digits / 14.181647462725477) + 2
    ...
    # HEAVY PATH: For massive numbers, engage the quad-core engine and memory clearing.
...
def main():
    ...
    while True:
        ...
        if not cmd:
            ...
            # Using perf_counter for maximum hardware timer accuracy
